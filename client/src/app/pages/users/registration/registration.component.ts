    ...
    <div class="row mt-4">
      <div class="col-md-6">
        <div class="row" style="height: 450px;">
          <div class="col-md-12 my-auto side-header text-center py-4">
            <img
            ...
            <p>
              <em>
                Using <strong>Asp.Net Core 2.2 Web Api</strong> and
          ...
          <div formGroupName="Passwords">
            <div class="form-group required">
              ...
              <span
                class="text-danger"
                *ngIf="
                  usersService.formModel.get('Passwords.Password').touched &&
            ...
            <span
              ...
              *ngIf="
                usersService.formModel.get('Passwords.ConfirmPassword')
                  .touched &&
                usersService.formModel.get('Passwords.ConfirmPassword').errors
                  ?.required
              "
            >
